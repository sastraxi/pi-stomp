...
BAND_SPECS: tuple[BandSpec, ...] = (
    BandSpec("L", "shelf", None, "fl", None, "boostl", "low",
             20.0, 14000.0, 0.1, 6.0, -50.0, 20.0, color=(255, 180, 80)),
    BandSpec("1", "peak", None, "f1", "bw1", "boost1", None,
             20.0, 14000.0, 0.1, 6.0, -50.0, 20.0, color=(255, 230, 80)),
    BandSpec("2", "peak", None, "f2", "bw2", "boost2", None,
             20.0, 14000.0, 0.1, 6.0, -50.0, 20.0, color=(130, 220, 110)),
    BandSpec("H", "shelf", None, "fh", None, "boosth", "high",
             20.0, 14000.0, 0.1, 6.0, -50.0, 20.0, color=(210, 130, 230)),
)
